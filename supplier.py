...
class supplierclass():
    def __init__(self,root):
        ...
        self.root.title("Inventory Management System  | Danish Jamadar,Sumedh Kadane,Shivraj Kabbin")
        ...
        btn_search=Button(self.root,text="search",command=self.search,font=("goudy old style",15),bg="silver",fg="black",cursor="hand2").place(x=980,y=79,width=100,height=28)
        ...
        #row3
        lbl_contact=Label(self.root,text="Contact No",font=("Goudy old style",15),bg="white").place(x=50,y=160)
        ...
        #button
        btn_add=Button(self.root,text="Save",command=self.add,font=("goudy old style",15),bg="blue",fg="black",cursor="hand2").place(x=180,y=370,width=110,height=35)
        btn_update=Button(self.root,text="Update",command=self.update,font=("goudy old style",15),bg="green",fg="black",cursor="hand2").place(x=300,y=370,width=110,height=35)
        btn_delete=Button(self.root,text="Delete",command=self.delete,font=("goudy old style",15),bg="red",fg="black",cursor="hand2").place(x=420,y=370,width=110,height=35)
        btn_clear=Button(self.root,text="Clear",command=self.clear,font=("goudy old style",15),bg="brown",fg="black",cursor="hand2").place(x=540,y=370,width=110,height=35)
