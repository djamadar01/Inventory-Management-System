...
class employeeClass:
    def __init__(self,root):
        ...
        #content
        #row1
        lbl_empid=Label(self.root,text="Emp ID",font=("Goudy old style",15),bg="white").place(x=50,y=140)
        lbl_gender=Label(self.root,text="Gender",font=("Goudy old style",15),bg="white").place(x=400,y=140)
        lbl_contact=Label(self.root,text="Contact",font=("Goudy old style",15),bg="white").place(x=750,y=140)
        ...
        btn_update=Button(self.root,text="Update",command=self.update,font=("goudy old style",15),bg="green",fg="black",cursor="hand2").place(x=620,y=305,width=110,height=28)
        btn_delete=Button(self.root,text="Delete",command=self.delete,font=("goudy old style",15),bg="red",fg="black",cursor="hand2").place(x=740,y=305,width=110,height=28)
        btn_clear=Button(self.root,text="Clear",command=self.clear,font=("goudy old style",15),bg="brown",fg="black",cursor="hand2").place(x=860,y=305,width=110,height=28)
        ...
        try:
            if self.var_emp_id.get()=="":
                ...
                if row==None:
                    ...
                    op=messagebox.askyesno("Cofirm","Doo you waant to really delete?",parent=self.root)
                    if op==True:
