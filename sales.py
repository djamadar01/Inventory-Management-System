...
class salesclass:
    def __init__(self,root):
       ...
       #Bill Area==
        ...
        lbl_title2=Label(bill_Frame,text="Customer Bill Area",font=("goudy old style",20),bg="orange",bd=3,relief=RIDGE).pack(side=TOP,fill=X)
       ...
       #==Image====
        ...
        lbl_image=Label(self.root,image=self.bill_photo,bd=10)
