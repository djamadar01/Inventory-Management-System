...
class productclass:
    def __init__(self,root):
        ...
        #====title=======
        title=Label(product_Frame,text="Manage Product Details",font=("goudy old style",18),bg="blue",fg="white").pack(side=TOP,fill=X)
        #====colume1======
        ...
        btn_update=Button(product_Frame,text="Update",command=self.update,font=("goudy old style",15),bg="green",fg="black",cursor="hand2").place(x=120,y=400,width=100,height=40)
        btn_delete=Button(product_Frame,text="Delete",command=self.delete,font=("goudy old style",15),bg="red",fg="black",cursor="hand2").place(x=230,y=400,width=100,height=40)
        btn_clear=Button(product_Frame,text="Clear",command=self.clear,font=("goudy old style",15),bg="brown",fg="black",cursor="hand2").place(x=340,y=400,width=100,height=40)
        ...
        try:
            if self.var_pid.get()=="":
                ...
                if row==None:
                    ...
                    op=messagebox.askyesno("Cofirm","Do you really want to delete?",parent=self.root)
                    if op==True:
